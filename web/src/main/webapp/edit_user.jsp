...
<div class="col-md-12">
    ...
    <form id="application" action=" ./" method="POST">
        ...
        <input name="password" type="password" id="applicationPassword" maxlength="20" placeholder="Change password" />

        <p id="applicationType">
            <select name="usertype" size="1" >
                <option value="HUMAN_RESOURCE" ${user.userType == 'HUMAN_RESOURCE' ? 'selected' : ''} >H-R</option>
