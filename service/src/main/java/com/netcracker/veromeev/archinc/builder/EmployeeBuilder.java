...
import com.netcracker.veromeev.archinc.dao.EmployeeDAO;
import com.netcracker.veromeev.archinc.dao.QualificationDAO;
import com.netcracker.veromeev.archinc.entity.Employee;
import com.netcracker.veromeev.archinc.entity.Qualification;
import com.netcracker.veromeev.archinc.enumeration.Education;
import com.netcracker.veromeev.archinc.enumeration.Gender;
...
public class EmployeeBuilder extends AbstractBuilder {
    ...
    public EmployeeBuilder address() throws BuilderException {
        if (this.employee.getAddressId() == 0) {
            ...
            this.addressBuilder =
                    new AddressBuilder(this.employee.getAddressId());
        }
        return this;
    }
    ...
    private void checkoutQualification() throws BuilderException {
        ...
        try {
            ...
            deleteQualification(this.qualification.getId());
